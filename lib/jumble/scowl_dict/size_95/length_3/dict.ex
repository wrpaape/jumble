defmodule Jumble.ScowlDict.Size95.Length3.Dict do
  def get do
    %{"bez" => ["bez"], "loy" => ["loy"], "abo" => ["abo", "oba", "boa"],
      ...
      "adz" => ["zad", "adz"], "aop" => ["opa", "poa"], "crv" => ["vcr"],
      ...
      "ahn" => ["han", "nah"], "ahh" => ["ahh", "hah"], "ahv" => ["hav"],
      "dux" => ["dux"], "rtw" => ["rtw"], "amn" => ["mna", "nam", "man"],
      "ajt" => ["jat", "taj"], "cry" => ["cry"], "bfl" => ["flb"],
      "gmu" => ["gum", "mug"], "hhs" => ["shh"], "iow" => ["iwo"], "pps" => ["pps"],
      "ehh" => ["heh"], "hrw" => ["whr"], "ppr" => ["prp"], "erv" => ["rev"],
      "aip" => ["pia"], "eew" => ["ewe", "wee"], "ghm" => ["mhg"], "cow" => ["cow"],
      "kps" => ["pks"], "ciy" => ["icy"], "ttu" => ["tut"], "bij" => ["jib"],
      "arw" => ["raw", "war"], "ivx" => ["xiv", "xvi"], "div" => ["vid"],
      "hpt" => ["tph", "pht"], "ksu" => ["suk"], "aag" => ["aga"], "cmo" => ["moc"],
      "mop" => ["pom", "mop"], "ejr" => ["jer"], "alm" => ["mal", "lam"],
      "dkm" => ["dkm"], "esx" => ["sex"], "rtt" => ["trt"], "eep" => ["pee"],
      "egp" => ["peg"], "cfy" => ["fcy"], "box" => ["box"], "ltu" => ["lut"],
      "bdl" => ["bld"], "aov" => ["avo", "ova"], "gnp" => ["gnp"], "erw" => ["rew"],
      "cmp" => ["cpm"], "agp" => ["gap"], "amu" => ["aum", "mau", "uma", "amu"],
      "cdg" => ["cdg", "gcd"], "mtu" => ["mut", "tum"], "cpu" => ["cup"],
      "ceg" => ["ecg"], "arx" => ["arx", "rax"], "osu" => ["ous", "sou"],
      "dho" => ["doh", "hod"], "opx" => ["pox"], "vxx" => ["xxv"], "ahl" => ["lah"],
      "etx" => ["tex"], "grr" => ["grr"], "dem" => ["dem"], "bmu" => ["bum"],
