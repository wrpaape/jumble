defmodule Jumble.LengthDict.Length22 do
  def get(string_id) do
    %{"acceeiiijknnoorsstttuv" => ["keratoconjunctivitises"],
      ...
      "aaciiiilnnnooossttttuz" => ["constitutionalizations"],
      ...
      "aeeeefhlllnooprrtttuyy" => ["polytetrafluorethylene"],
      ...
      "Daaabeehiiilmnnrsssstt" => ["Disestablishmentarians"],
      ...
      "aaceeeehhillmooprrssty" => ["hypercholesterolaemias"],
      ...
      "aaciiiilnnnooosssttttu" => ["constitutionalisations"],
      ...
      "accceiiilllmmooorrrtuy" => ["microcolourimetrically"],
