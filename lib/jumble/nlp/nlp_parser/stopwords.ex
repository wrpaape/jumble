defmodule Jumble.NLP.NLPParser.Stopwords do
  def get do
    [
      ...
      "mostly", "much", "must", "mustn't", "my", "myself", "name", "namely", "nd",
      ...
      "sup", "sure", "t's", "take", "taken", "tell", "tends", "th", "than", "thank",
      ...
      "whatever", "when", "when's", "whence", "whenever", "where", "where's",
      "whereafter", "whereas", "whereby", "wherein", "whereupon", "wherever",
      "whether", "which", "while", "whither", "who", "who's", "whoever", "whole",
      "whom", "whose", "why", "why's", "will", "willing", "wish", "with", "within",
